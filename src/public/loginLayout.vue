    ...
    <div class="layout">
                ...
                <div class="top___3tcoI">
                    <div class="header___3StSZ">
                        <a href="#">
                            ...
                            <span class="title___2h165">VueCli3.0 + TypeScript</span>
                        </a>
                    </div>
                    <div class="desc___i73Yc">Ant Design 是世界最具影响力的 Web 设计规范</div>
                </div>
        ...
        <Footer>
            ...
            <div class="index__copyright___3hvsv">Copyright
                <i class="anticon anticon-copyright"></i> 2018 共同进步体验技术部出品</div>
        </Footer>
    </div>
</template>
<style lang="scss">
